...
public class QrCodeUtils1 {
    ...
    public static String encode(String content, String logoPath, String destPath, boolean needCompress) {
        ...
        try {
            image = QrCodeUtils1.createImage(content, logoPath, needCompress,null);
            mkdirs(destPath);
    ...
    public static String encode(String content, String logoPath, String destPath, String fileName, boolean needCompress) {
        BufferedImage image = null;
        try {
            image = QrCodeUtils1.createImage(content, logoPath, needCompress, fileName);
            mkdirs(destPath);
    ...
    public static void encode(String content, String logoPath, OutputStream output, boolean needCompress)
            throws Exception {
        BufferedImage image = QrCodeUtils1.createImage(content, logoPath, needCompress,null);
    ...
    public static String decode(String path) throws Exception {
        return QrCodeUtils1.decode(new File(path));
    }

    public static void main(String[] args) throws Exception {
        String text = "http://1c592r8399.51mypc.cn/html/?code=431832463834534D066DFF33";
        //不含Logo  
        ...
        //含Logo，指定二维码图片名  
        String qrcode = QrCodeUtils1.encode(text, "C:\\Users\\Administrator\\Desktop\\1.jpg", "C:\\Users\\Administrator\\Desktop", "qrcode3", true);
