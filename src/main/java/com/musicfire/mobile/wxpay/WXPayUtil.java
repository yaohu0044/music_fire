package com.musicfire.mobile.wxpay;
...
public class WXPayUtil {
    ...
    public static Map<String, String> doXMLParse(String xml) throws XmlPullParserException, IOException {
        ...
        map = getStringStringMap(map, pullParser, eventType);
        return map;
    }
    ...
    public static Map<String, String> doXMLParseInputStream(InputStream inputStream) throws XmlPullParserException, IOException {
        ...
        pullParser.setInput(inputStream, "UTF-8");
        int eventType = pullParser.getEventType();
        map = getStringStringMap(null, pullParser, eventType);
        return map;
    }

    private static Map<String, String> getStringStringMap(Map<String, String> map, XmlPullParser pullParser, int eventType) throws XmlPullParserException, IOException {
    ...
    public static String getMoney(BigDecimal  amount) {
       BigDecimal newAmount = amount.multiply(new BigDecimal(100));
        int amountInt = newAmount.intValue();
        return  Integer.toString(amountInt);
    }
